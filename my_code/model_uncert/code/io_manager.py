...
def table_H_trans_by_type_alg(myPars: Pars, H_trans_alg_0: np.ndarray, H_trans_alg_1: np.ndarray, 
    ...
    tab = [
        ...
        "\\hline \n",
        "\\\\[0.5mm] \n",
        "Typing Method & Low Type & Poor & Good & High Type & Poor & Good \\\\ \n",
        "\\cmidrule(lr){1-1} \\cmidrule(lr){2-4} \\cmidrule(lr){5-7} \n",
        f"50pth Cutoff  & Poor & {round(H_trans_alg_0[0,0,0], 3)} & {round(H_trans_alg_0[0,0,1], 3)} & Poor & {round(H_trans_alg_0[1,0,0], 3)} & {round(H_trans_alg_0[1,0,1], 3)} \\\\ \n",
        ...
        "Typing Method & Low Type & Poor & Good & High Type & Poor & Good \\\\ \n",
        "\\cmidrule(lr){1-1} \\cmidrule(lr){2-4} \\cmidrule(lr){5-7} \n",
        f"$k$-means$\\left(k=2\\right)$ & Poor & {round(H_trans_alg_1[0,0,0], 3)} & {round(H_trans_alg_1[0,0,1], 3)} & Poor & {round(H_trans_alg_1[1,0,0], 3)} & {round(H_trans_alg_1[1,0,1], 3)} \\\\ \n",
