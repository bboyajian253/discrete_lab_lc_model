            ...
            for starting_h_ind in prange(myPars.H_grid_size):        
                for H_type_perm_ind in prange(myPars.H_type_perm_grid_size):
                    for sim_ind in prange(myPars.sim_draws):
                        ...
                        a = sim_a[lab_fe_ind, starting_h_ind, H_type_perm_ind, sim_ind, j]
                        ...
                        curr_h_ind = myShocks.H_hist[lab_fe_ind, starting_h_ind, H_type_perm_ind, sim_ind, j]
                        ...
                        sim_c[lab_fe_ind, starting_h_ind, H_type_perm_ind, sim_ind, j] = c
                        sim_lab[lab_fe_ind, starting_h_ind, H_type_perm_ind, sim_ind, j] = lab
                        sim_a[lab_fe_ind, starting_h_ind, H_type_perm_ind, sim_ind, j + 1] = a_prime
                        sim_wage[lab_fe_ind, starting_h_ind, H_type_perm_ind, sim_ind, j] = wage
                        sim_lab_income[lab_fe_ind, starting_h_ind, H_type_perm_ind, sim_ind, j] = lab_income
