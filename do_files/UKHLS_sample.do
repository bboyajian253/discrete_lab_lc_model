...
// xtile wage_percentiles = wage if emp ==1 [pweight = wght], nq(1000)
...
// drop if wage_percentiles > 995 & emp == 1 & wage !=.  // Drop the top 1% of wage earners
// do "$dodir/test.do"
...
do "$dodir/gen_health_states_types.do"
