...
do $dodir/UKHLS_data_clean    /* clean the data and generate input file for estiamtion of various statistics */


do $dodir/UKHLS_probs.do      /* estimate health transition probabilities/profiles */

do $dodir/UKHLS_estHealthShock.do /* estimates the health shock process*/
